            ...
            <main className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 max-w-4xl mx-auto w-full">
                ...
                >
                    ...
                    <p className="text-gray-500 font-light max-w-lg mx-auto">
                        Nous avons trouvé plusieurs transactions à cette adresse. Sélectionnez celle qui correspond à votre bien (surface/pièces similaire) pour affiner l'analyse.
                    </p>
                </motion.div>
